...
class CreateJobsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('jobs', function (Blueprint $table) {
            ...
            $table->integer('moneyForShop')->nullable()->comment('The amount paid to the shop by the supplier');
            $table->integer('moneyForSupplier')->nullable()->comment('The amount given to the supplier by the consumer');
